...
class XMLToJSONConverter:
    ...
    def convert_file(self, xml_path: Union[str, Path], 
        ...
        try:
            ...
            if not self.validator.is_valid_xml_file(xml_path):
                print(f"❌ Arquivo XML inválido: {xml_path}")
                return None
            ...
            if json_path:
                ...
                if self._save_json_file(json_data, json_path, **kwargs):
                    ...
                    print(f"❌ Erro ao salvar arquivo JSON: {json_path}")
                    return None
    ...
    def convert_string(self, xml_string: str, **kwargs) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"❌ Erro na conversão de string: {e}")
            return None
    ...
    def convert_batch(self, input_dir: Union[str, Path], 
        ...
        if not xml_files:
            print(f"❌ Nenhum arquivo XML encontrado em: {input_dir}")
            return results
